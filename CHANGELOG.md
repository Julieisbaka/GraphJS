...
- Added an explicit `repository.url` pointing at `https://github.com/Julieisbaka/GraphJS` so npm Trusted Publishing can match the root package metadata to the GitHub repository during publish authorization.
